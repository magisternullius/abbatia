...
De él se dice a menudo que fue un "genio de la informática". La verdad es más sencilla: Carlo era un muchacho curioso, bastante _geek_, inquieto. Hizo páginas web, sí, pero no fue un visionario técnico ni un pionero digital. Ni mucho menos un _influencer_. Y quizá ahí está precisamente su grandeza: no hace falta ser un genio para ser santo.
...
Por eso, Carlo no es solo patrimonio de los jóvenes, sino de todos nosotros que habitamos este bazar donde las opiniones se compran, venden y regalan a gritos. Él nos enseñó a usar la red _ad maiorem Dei gloriam_ y a no quedar atrapados en su espejismo. Carlo es la realidad de la Eucaristía frente a la hiperrealidad de las redes: allí donde todo es reflejo, comentario, espectáculo, él nos devolvió a lo sólido, a lo verdadero, a lo que no pasa.
...
Se conservan, sin embargo, algunos retazos de la web original, como sus famosos [_secretos especialísimos para llegar rápidamente a la santidad_](https://web.archive.org/web/20080314232401/http://www.carloacutis.org/pages/amis.html), que recuerdan a las [cuatro resoluciones](https://donbosconorte.org.ar/domingo-savio-la-grandeza-lo-pequeno/) que Santo Domingo Savio tomó el día de su Primera Comunión. Carlo es más un santo del siglo XIX que, por Providencia, murió en el XXI.

De su sección de milagros eucarísticos no queda nada del código original: únicamente lo que Wayback Machine [logró capturar](https://web.archive.org/web/20080919220647/https://www.miracolieucaristici.org/) en Septiembre de 2008, cuando ya se había iniciado la reelaboración devocional. Algo de la parte en Flash puede todavía verse y escucharse en el archivo, pero la mayor parte se ha perdido. El sitio utilizaba además PHP, lo que hacía que buena parte del contenido dinámico no quedara archivado[^lostmedia] ni indexado en buscadores.

Una búsqueda limitada en Google [entre 2000 y 2005](https://www.google.com/search?q=%22miracoli+eucaristici%22&hl=es&lr=&as_qdr=all&tbs=cdr:1,cd_min:1/1/2000,cd_max:12/31/2005) no arroja resultados para la página de milagros eucarísticos, ni mucho menos una exposición[^exposición]. Esto sugiere que Carlo no la concibió como un proyecto evangelizador de masas, sino como un espacio personal de piedad. Más que un _influencer_, Carlo fue un adolescente que programaba para orar y contemplar, no para acumular visitas.
...
En la misma época en que tantos adolescentes abrían páginas en Geocities y MySpace, o daban sus primeros pasos con Linux, Carlo supo dedicar su afición digital a Cristo. Su mérito no está en la técnica, sino en la dirección: orientar lo pequeño hacia lo eterno; a _ser fiel en lo poco_.
...
[^exposición]: Conviene distinguir entre la sencilla web que Carlo preparó en vida (2003–2006) y la posterior exposición internacional. La cifra de "10.000 parroquias y santuarios" corresponde a la difusión institucional después de su muerte, cuando el material fue reelaborado y promovido con respaldo oficial. Presentarlo como si un adolescente hubiese coordinado personalmente esa logística global es un anacronismo hagiográfico: lo suyo fue un trabajo amateur y devocional, no una operación pastoral de gran escala.
[^dominios]: El dominio [carloacutis.org](http://carloacutis.org) estuvo activo hasta 2021, pasando de ser la web personal de Carlo a convertirse en la página de la asociación para la causa de su beatificación, la cual ocurrió en 2020. A partir de 2022-2023 aparece aparcado bajo el registrador austríaco Key-Systems, sin relación aparente con la familia Acutis o los sites oficiales. Por su parte, [carloacutis.net](http://carloacutis.net) redirige a carloacutis.com.
[^gamer]: Carlo no era un gamer. Le gustaban los videojuegos, pero se imponía un límite muy estricto: máximo una hora por semana. Además, lo justificaba con argumentos concretos: conocía los riesgos del abuso (hospitalizaciones, epilepsia, adicciones) y quería conservar una libertad interior frente a cualquier instrumento tecnológico, incluso el ordenador. Véase Antonia Salzano, "El secreto de Carlo Acutis", Ed. San Pablo (2022).
[^cuidador]: Entrevista a Rajesh Mohur, cuidador de Carlo Acutis, [Infovaticana](https://infovaticana.com/2025/09/08/el-cuidador-de-carlo-acutis-yo-me-quedaba-a-unos-metros-y-lo-observaba-se-ponia-delante-del-sagrario-como-si-alguien-lo-esperara-alli/), 8 de Septiembre de 2025.
