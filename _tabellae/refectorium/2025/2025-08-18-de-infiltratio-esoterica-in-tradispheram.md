...
Otro de estos personajes de X aparece como un raro híbrido: entre hilos extensos sobre mística medieval se intercala _shitposting_[^2] sobre tropos anime. Lo desconcertante es que, detrás de la estética otaku y del tono ligero, se percibe un autor real, con lecturas amplias y mucha erudición. Cita a autores como **Gershom Scholem**[^f], **Jean Borella** o **Eric Perl**, y se mueve con soltura entre el neoplatonismo[^1] y la escolástica franciscana. Su consejo recurrente es claro: antes de leer a un autor de la Tradición Auténtica conviene pasar por determinados filtros no católicos, **casi como si el acceso a la fuente tuviera que estar mediado por un itinerario previo de autores** antiguos y modernos.
...
Frente a esta ambigüedad, el poeta y ensayista **Enrique García-Máiquez** (1969) ha propuesto rescatar el concepto en clave hispánica bajo el nombre de **hidalguía de espíritu**. En su ensayo _Ejecutoria: una hidalguía del espíritu_, ganador del Premio Sapientia Cordis[^11], presenta esta síntesis:
...
Así, ni siquiera los católicos conservadores _búmers_ -cuyo último contacto con la animación nipona fue **Mazinger Z** o **Dragon Ball**- se libran de estas _emanaciones perennialistas_.

#### El verdadero modelo: la dignidad de los hijos de Dios

La tradición católica va más allá. La nobleza última del hombre no se funda en linaje humano ni en aristocracia moral, sino en la dignidad bautismal. No somos hidalgos _fijos d'algo terreno_, sino hijos de Dios:
...
El resultado es un flujo constante de contenido que imita la voz de un erudito o de un joven insider, pero que en realidad responde a la lógica del simulacro: atraer, retener y desplazar el marco doctrinal hacia un perennialismo híbrido con tintes _far-right_.
